        ...
        private void Clicked(object sender, EventArgs e)
        {
            if (!firstLoad)
            {
                ...
                if (chkClearTempAtStart.Checked == true)
                {
                    ...
                    //taskInformationPostDto.TaskName = "Setting: Clear Temp at start (true)";
                    //taskInformationPostDto.UserName = EUCProfileBuddy.UserDetail.UserName;
                    //taskInformationPostDto.TaskCurrentState = TaskState.Completed;
                    //EUCProfileBuddy.TaskInformationClient.AddTaskInformationAsync(taskInformationPostDto);
                }
                else
                {
                    ...
                    //taskInformationPostDto.TaskName = "Setting: Clear Temp at start (false)";
                    //taskInformationPostDto.UserName = EUCProfileBuddy.UserDetail.UserName;
                    //taskInformationPostDto.TaskCurrentState = TaskState.Completed;
                    //EUCProfileBuddy.TaskInformationClient.AddTaskInformationAsync(taskInformationPostDto);
                }
